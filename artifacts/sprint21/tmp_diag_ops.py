...
temp_root = Path(tempfile.mkdtemp(prefix="diag_ops_", dir=str(logs_root)))
...
print("bootstrap=", controller.bootstrap_once(trigger="diag"))
print("run=", controller.run_once(trigger="diag"))
